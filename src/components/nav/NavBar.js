...
function NavBar() {
  return (
    <div className="navbar">
      <a className="link-wrapper" href="/test">
        <span className="fallback">Index</span>
        <div className="img-wrapper">
          <img
            className="normal"
            src="https://i.imgur.com/H4JD35M.png"
            alt="img"
          />
          <img
            className="active"
            src="https://i.imgur.com/ELytdKg.png"
            alt="img"
          />
        </div>
      ...
      <a className="link-wrapper" href="/test">
        ...
        <div className="img-wrapper">
          <img
            className="normal"
            src="https://i.imgur.com/YchoxsT.png"
            alt="img"
          />
          <img
            className="active"
            src="https://i.imgur.com/gebq1bn.png"
            alt="img"
          />
        </div>
        <div className="shape-wrapper">
      ...
      <a className="link-wrapper" href="/test">
        ...
        <div className="img-wrapper">
          <img
            className="normal"
            src="https://i.imgur.com/sayXMqS.png"
            alt="img"
          />
          <img
            className="active"
            src="https://i.imgur.com/ZgQQSH7.png"
            alt="img"
          />
        </div>
        <div className="shape-wrapper">
      ...
      <a className="link-wrapper" href="/test">
        ...
        <div className="img-wrapper">
          <img
            className="normal"
            src="https://i.imgur.com/dEjjgFK.png"
            alt="img"
          />
          <img
            className="active"
            src="https://i.imgur.com/x39xRIo.png"
            alt="img"
          />
        </div>
        <div className="shape-wrapper">
      ...
      <a className="link-wrapper" href="/test">
        ...
        <div className="img-wrapper">
          <img
            className="normal"
            src="https://i.imgur.com/qOmAPIS.png"
            alt="img"
          />
          <img
            className="active"
            src="https://i.imgur.com/fZEEHjw.png"
            alt="img"
          />
        </div>
        <div className="shape-wrapper">
      ...
      <a className="link-wrapper" href="/test">
        ...
        <div className="img-wrapper">
          <img
            className="normal"
            src="https://i.imgur.com/VqPute6.png"
            alt="img"
          />
          <img
            className="active"
            src="https://i.imgur.com/ts0Amew.png"
            alt="img"
          />
        </div>
        <div className="shape-wrapper">
      ...
      <a className="link-wrapper" href="/test">
        <span className="fallback">Credits</span>
        <div className="img-wrapper">
          <img
            className="normal"
            src="https://i.imgur.com/rUW98fP.png"
            alt="img"
          />
          <img
            className="active"
            src="https://i.imgur.com/QjRkjPV.png"
            alt="img"
          />
        </div>
        <div className="shape-wrapper">
      ...
      <div style={{ height: "100px" }}>AHHHH</div>
    </div>
  );
}
